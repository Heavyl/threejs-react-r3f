...
export const TRANSLATIONS = Object.freeze({
  en: {
    ...
    analysis: {
      open: 'Analyze',
      closeMode: 'Close analysis',
      panelLabel: 'Internal structure analysis',
      eyebrow: 'Planet analysis',
      informationPanelLabel: 'Spacecraft information',
      informationEyebrow: 'Spacecraft analysis',
      audioVisualizer: 'Live sonification visualizer',
      close: 'Close analysis',
      overview: 'Key facts',
      layers: 'Internal layers',
      informationSections: 'Information',
  ...
  fr: {
    ...
    analysis: {
      open: 'Analyser',
      closeMode: 'Fermer l’analyse',
      panelLabel: 'Analyse de la structure interne',
      eyebrow: 'Analyse planétaire',
      informationPanelLabel: 'Informations sur l’engin',
      informationEyebrow: 'Analyse de l’engin',
      audioVisualizer: 'Visualiseur de sonification en direct',
      close: 'Fermer l’analyse',
      overview: 'Caractéristiques générales',
      layers: 'Couches internes',
      informationSections: 'Informations',
